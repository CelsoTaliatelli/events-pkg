...
func (suite *EventDispatcherTestSuite) TestEventDispatcherTest_Register() {
...
func (suite *EventDispatcherTestSuite) TestEventDispatcherTest_Register_WithSameHandler() {
	err := suite.eventDispatcher.Register(suite.event.GetName(), &suite.handler)
	suite.Nil(err)
	suite.Equal(1, len(suite.eventDispatcher.handlers[suite.event.GetName()]))
...
func (suite *EventDispatcherTestSuite) TestEventDispatcherTest_Clear() {
	//Event 1
	err := suite.eventDispatcher.Register(suite.event.GetName(), &suite.handler)
	suite.Nil(err)
	suite.Equal(1, len(suite.eventDispatcher.handlers[suite.event.GetName()]))
...
func (suite *EventDispatcherTestSuite) TestEventDispatcherTest_Has() {
	//Event 1
	err := suite.eventDispatcher.Register(suite.event.GetName(), &suite.handler)
	suite.Nil(err)
	suite.Equal(1, len(suite.eventDispatcher.handlers[suite.event.GetName()]))
